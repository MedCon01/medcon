-- H2 2.1.214;
;             
CREATE USER IF NOT EXISTS "SA" SALT 'edfb5c3589491ea8' HASH 'ed083413d6da89a31fb640eb272b631d6b31256a735da2ff7738313290d04825' ADMIN;         
CREATE CACHED TABLE "PUBLIC"."PACIENTES"(
    "ID" CHARACTER VARYING(6) NOT NULL,
    "DNI" CHARACTER VARYING(9) NOT NULL,
    "NOMBRE_APELLIDOS" CHARACTER VARYING(255) NOT NULL,
    "FECHA_NACIMIENTO" DATE NOT NULL,
    "N_TARJETA" BIGINT NOT NULL,
    "CITA" INTEGER,
    "PRESENTE" BOOLEAN NOT NULL
);      
ALTER TABLE "PUBLIC"."PACIENTES" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_E" PRIMARY KEY("ID");    
-- 13 +/- SELECT COUNT(*) FROM PUBLIC.PACIENTES;              
INSERT INTO "PUBLIC"."PACIENTES" VALUES
...
CREATE CACHED TABLE "PUBLIC"."MEDICOS"(
    "DNI" CHARACTER VARYING(9) NOT NULL,
    "NOMBRE_APELLIDOS" CHARACTER VARYING(255) NOT NULL,
...
ALTER TABLE "PUBLIC"."MEDICOS" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_6" PRIMARY KEY("DNI");     
-- 5 +/- SELECT COUNT(*) FROM PUBLIC.MEDICOS; 
INSERT INTO "PUBLIC"."MEDICOS" VALUES
...
ALTER TABLE "PUBLIC"."MEDICOS" ADD CONSTRAINT "PUBLIC"."N_COLEGIADO" UNIQUE("N_COLEGIADO");   
ALTER TABLE "PUBLIC"."PACIENTES" ADD CONSTRAINT "PUBLIC"."DNI" UNIQUE("DNI"); 
ALTER TABLE "PUBLIC"."PACIENTES" ADD CONSTRAINT "PUBLIC"."CITA" FOREIGN KEY("CITA") REFERENCES "PUBLIC"."CITA"("ID") NOCHECK; 
ALTER TABLE "PUBLIC"."CITA" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_1F9" FOREIGN KEY("MEDICO") REFERENCES "PUBLIC"."MEDICOS"("DNI") NOCHECK;      
ALTER TABLE "PUBLIC"."CITA" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_1F" FOREIGN KEY("PACIENTE") REFERENCES "PUBLIC"."PACIENTES"("ID") NOCHECK;    
